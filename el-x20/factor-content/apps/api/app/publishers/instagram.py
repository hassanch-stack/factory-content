"""InstagramAdapter — stub. Regla de trabajo del spec (sección 29): antes de
implementar contra la Graph API (Instagram) real hay que confirmar en la
documentación oficial vigente los items de
docs/07_PLATFORM_INTEGRATION_CHECKLIST.md (sección Instagram) — no se asume
nada aquí todavía.
...
_NOT_READY = (
    "InstagramAdapter no implementado: falta confirmar contra la documentación "
    "oficial vigente de la Graph API (Instagram) (ver "
    "docs/07_PLATFORM_INTEGRATION_CHECKLIST.md, sección Instagram) antes de "
